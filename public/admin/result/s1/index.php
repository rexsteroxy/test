...
$ssecondsemester = find_all_secondsemester();
...
<table class="table table-striped table-bordered table-hover table-condensed text-center">
	...
	<?php while($secondsemester = mysqli_fetch_assoc($ssecondsemester)) {?>
		<tr class="text-info">
			...
			<td><a class="action" href="<?php echo url_for('/admin/result/s1/view_result.php?id=' . $secondsemester['id']) ;?>">click to view</a></td>
