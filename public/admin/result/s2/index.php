...
$ssecondsemester = find_all_secondsemester2();
...
?>
    ...
    <div class="row "> 
        <div class="col-md-12 col-lg-12 col-sm-12">
            ...
            <h4 class="text-success text-center">YEAR TWO SECOND SEMESTER RESULT</h4>
...
<table class="table table-striped table-bordered table-hover table-condensed text-center">
	...
	<?php while($secondsemester = mysqli_fetch_assoc($ssecondsemester)) {?>
		<tr class="text-info">
			...
			<td><a class="action" href="<?php echo url_for('/admin/result/s2/view_result.php?id=' . $secondsemester['id']) ;?>">click to view</a></td>
